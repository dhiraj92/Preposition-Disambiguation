...
public class ParsingScript {
	...
	public final static String DEFAULT_SENTENCE_READER_CLASS = miacp.parse.io.ConllxSentenceReader.class.getName();
	...
	private static CommandLineOptions createOptions() {
		...
		cmdOpts.addOption(OPT_SENTENCE_READER, "classname", "sentence reader class name (implements " + miacp.parse.io.SentenceReader.class.getName() + " )");
		cmdOpts.addOption(OPT_SENTENCE_WRITER, "classname", "sentence writer class name (implements " + miacp.parse.io.SentenceWriter.class.getName() + " )");
