...
import miacp.parse.io.SentenceWriter;
...
import miacp.semantics.ClassificationBundle;
...
public class ParseScriptForEval {
	...
	private static CommandLineOptions createOptions() {
		...
		cmdOptions.addOption(OPT_SENTENCE_READER_CLASS, "classname", "the name of the sentence reading class (must implement " + miacp.parse.io.SentenceReader.class.getName() + ")");
		cmdOptions.addOption(OPT_SENTENCE_WRITER_CLASS, "classname", "the name of the sentence writing class (must implement " + miacp.parse.io.SentenceWriter.class.getName() + ")");
		...
		for(String file : files) {
			...
			for(Sentence sentence : sentences) {
				...
				sentenceWriter.appendSentence(sentence, 
						                      parse, 
						                      parseCopy == null ? null : parseCopy.getHeadArcs());
			}
		}
