...
import miacp.types.FloatArrayList;
...
public class TrainablePerceptron extends AbstractParseModel {
	...
	public TrainablePerceptron(List<String> actions) {
		...
		// dummy object at index 0 (consider removing)
	...
	@Override
	//
	public void update(String action, Collection<String> featureStrings, double change) { //
		int actionIndex = getActionIndex(action, true);
		//System.err.println("ActionIndex: " + action + " " + actionIndex + " " + change);
		IntArrayList feats = new IntArrayList(featureStrings.size());
		for(String featureString : featureStrings) {
			feats.add(getIndex(featureString, true));
		}
