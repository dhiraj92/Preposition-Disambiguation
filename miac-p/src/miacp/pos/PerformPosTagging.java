...
public class PerformPosTagging {
	...
	public static CommandLineOptions createOptions() {
		...
		opts.addOption(OPT_SENTENCE_READER, "classname", "name of the class for reading in the sentences (should implement " + miacp.parse.io.SentenceReader.class.getName() + ")");
		opts.addOption(OPT_SENTENCE_WRITER, "classname", "name of the class for writing out the tagged sentences (should implement " + miacp.parse.io.SentenceWriter.class.getName() + ")");
